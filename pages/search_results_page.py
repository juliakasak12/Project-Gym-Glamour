...
class SearchResultsPage(BasePage):
    ...
    def _verify_page(self):
        print("Weryfikacja wyników strony wyszukiwania")
        product_button = self.driver.find_element(*SearchResultsPageLocators.PRODUCT_BUTTON)
        self.wait_5s.until(EC.element_to_be_clickable(product_button))
